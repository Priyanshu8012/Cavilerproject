...
const Olampiad = () => {
  ...
  const sections = [
    { name: "Top Student ", link: "/Top-student" },
    { name: "Course", link: "/Olampiad-Courses-Update" },
    { name: "Offer Course", link: "/Olampiad-offer" },
    { name: "Testinomial Update", link: "/Olampiad-testinomial" },
  ];
