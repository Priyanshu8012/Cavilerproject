...
import { FaCloudUploadAlt, FaFilePdf, FaTrashAlt, FaHistory, FaFilter, FaLightbulb } from "react-icons/fa";
...
const ImportantQuestions = () => {
  ...
  const API_BASE = import.meta.env.VITE_BASE_URL + "/api/important-questions";

  // Fetch previously uploaded data
  useEffect(() => {
    axios
      .get(API_BASE)
  ...
  const handleDelete = async (id) => {
    ...
    try {
      ...
      setPreviousPapers((prev) => prev.filter((p) => p.id !== id));
