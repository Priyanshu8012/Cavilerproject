...
const Dashboard = () => {
  ...
  const sections = [
    { name: "Update Banner ", link: "/Update-Banner-1" },
    { name: "Update Address Details", link: "/Update-Address-Details" },
    { name: "Title Update", link: "/Title-update" },
    { name: "Price Update", link: "/Price-Update" },
    { name: "Time Table Update", link: "/Time-table-update" },
  ];
