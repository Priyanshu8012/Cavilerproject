...
export default function NCRTsolutions() {
  ...
  const handleDownload = async (item) => {
    try {
      ...
      a.href = url;
      a.download = `NCERT-Solutions-${item.year}-${item.filename || 'solutions'}.pdf`;
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Access and download NCERT textbook solutions for Foundation courses.
            All solutions are available in PDF format to help you understand concepts better.
          </p>
        </div>
