...
export default function BoardPapers() {
  ...
  const handleDownload = async (paper) => {
    try {
      ...
      a.href = url;
      a.download = `Board-Exam-${paper.year}-${paper.filename || 'paper'}.pdf`;
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white py-16 px-6 md:px-12 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading Board papers...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Access and download Board exam previous year question papers for classes 10th and 12th.
        ...
        {papers.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 text-lg">No Board papers available yet.</p>
