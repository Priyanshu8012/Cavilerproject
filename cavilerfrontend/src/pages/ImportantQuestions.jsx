...
export default function ImportantQuestions() {
    ...
    const fetchQuestions = async () => {
      try {
        ...
        const formattedData = res.data
          .filter((item) => item.course?.toLowerCase() === "neet" && item.url)
          .map((item) => ({
            ...item,
            ...
            title: `NEET Important Questions (${item.year})`
          }));
  ...
  const handleDownload = async (item) => {
    try {
      ...
      a.href = url;
      a.download = `NEET-Important-Questions-${item.year}-${item.filename || 'questions'}.pdf`;
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Access and download NEET important questions and practice papers to boost your medical entrance preparation.
            All questions are available in PDF format.
          </p>
        </div>
        ...
        {questions.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 text-lg">No NEET important questions available yet.</p>
