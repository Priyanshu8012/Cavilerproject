...
export default function IITJEEPapers() {
  ...
  useEffect(() => {
    const fetchPapers = async () => {
      try {
        ...
        const iitJeeOnly = res.data
          .filter(
            (paper) =>
              paper.course &&
              paper.course.toLowerCase() === "iit-jee" &&
              paper.url
          )
          .map((paper) => ({
            ...paper,
  ...
  const handleDownload = async (paper) => {
    try {
      ...
      a.href = url;
      a.download = `IIT-JEE-${paper.year}-${paper.filename || 'paper'}.pdf`;
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Access and download IIT JEE previous year question papers to boost your preparation.
        ...
        {papers.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 text-lg">No IIT JEE papers available yet.</p>
