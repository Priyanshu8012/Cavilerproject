...
export default function NCRTsolutions() {
      ...
      try {
        ...
        const formattedData = res.data
          ...
          .map((item) => ({
            ...
            title: `NCERT Solutions (${item.year})`
          }));
  ...
  const handleDownload = async (item) => {
    try {
      ...
      a.href = url;
      a.download = `NCERT-Solutions-Board-${item.year}-${item.filename || 'solutions'}.pdf`;
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Access and download NCERT textbook solutions for Board exams (Classes 10th & 12th).
            All solutions are available in PDF format to help you prepare effectively.
          </p>
        </div>
