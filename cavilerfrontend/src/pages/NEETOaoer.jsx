...
export default function NEETPapers() {
  ...
  useEffect(() => {
    const fetchPapers = async () => {
      try {
        const res = await axios.get(`${BASE_URL}/api/papers`);
        const neetOnly = res.data
          .filter(
            (paper) =>
              paper.course &&
              paper.course.toLowerCase() === "neet" &&
              paper.url
          )
          .map((paper) => ({
            ...paper,
        ...
        console.error("Error fetching NEET papers:", err);
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleDownload = async (paper) => {
    try {
      ...
      a.href = url;
      a.download = `NEET-${paper.year}-${paper.filename || 'paper'}.pdf`;
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-50 to-white py-16 px-6 md:px-12 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading NEET papers...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-12">
          ...
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            Access and download NEET previous year question papers to boost your medical entrance preparation.
        ...
        {papers.length === 0 ? (
          <div className="text-center py-12">
            ...
            <p className="text-gray-500 text-lg">No NEET papers available yet.</p>
                ...
                <div className="flex items-start gap-4 mb-4">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-500">
                      {paper.originalName || `Paper ${paper.year}`}
                    </p>
                    {paper.fileSize && (
